...
class DataCleaner:
    ...
    def clean_water_utilities_assets(self, df: pd.DataFrame) -> pd.DataFrame:
    ...
    def clean_industrial_data(self, df: pd.DataFrame, filename: str) -> pd.DataFrame:
        ...
        if 'water_utilities_assets.csv' in filename:
            return self.clean_water_utilities_assets(df)
