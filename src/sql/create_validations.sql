...
ALTER TABLE water_utilities_assets DROP CONSTRAINT chk_asset_status;
ALTER TABLE water_utilities_assets DROP CONSTRAINT chk_asset_dates;
...
ALTER TABLE water_utilities_assets ADD CONSTRAINT chk_asset_status CHECK (status IN ('ACTIVE', 'INACTIVE', 'MAINTENANCE', 'DECOMMISSIONED'));
ALTER TABLE water_utilities_assets ADD CONSTRAINT chk_asset_dates CHECK (installation_date <= last_maintenance_date AND last_maintenance_date <= next_maintenance_date);
...
SELECT 
    'water_utilities_assets' as table_name,
    COUNT(*) as total_rows,
