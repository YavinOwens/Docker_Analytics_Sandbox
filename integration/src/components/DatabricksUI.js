                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="border rounded-md p-4 bg-white shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="border p-3 rounded">
                        <div className="text-sm text-gray-500">Growth MoM</div>
                ...
                <div className="border rounded-md overflow-hidden">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Customer ML Model Training</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Weekly on Sunday</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Apr 6, 2025 4:00 AM</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Success</span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      ...
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Data Quality Checks</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Daily @ 6:00 AM</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Apr 11, 2025 6:00 AM</td>
                        <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="w-72 bg-gray-50 border-l p-4">
          ...
          <div className="border-t pt-4 mt-4">
            ...
            <div className="text-sm">
              ...
              <div className="flex justify-between mb-1">
                <div className="text-gray-600">Spark User:</div>
                <div>johndoe</div>
              </div>
